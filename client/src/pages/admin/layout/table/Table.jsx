...
function Dashboard({ datas, onDelete }) {
                                    ...
                                    datas && datas.map((product) => {
                                        return (
                                            <Tr key={product.id}>
                                                ...
                                                <Td>
                                                    <Link onClick={() => navigate("/detail/" + product.id)} className={styles.dashboardLink}>{product.name}</Link>
                                                </Td>
                                                ...
                                                <Td>
                                                    <FaRegEdit className={`${styles.dashboardIcon} ${styles.edit}`} />
                                                </Td>
                                                <Td >
                                                    <MdDelete 
                                                        className={`${styles.dashboardIcon} ${styles.delete}`} 
